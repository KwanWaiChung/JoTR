...
from convlab.data.multiwoz.goal_generator2 import GoalGenerator
...
class UserPolicyAgendaMultiWoz:
    ...
    def __init__(self, max_turn=20, domains=None, seeder=Dict[str, Any]):
        """
    ...
    def init_session(self, ini_goal=None):
        ...
        # debug
        self.domain_goals_copy = copy.deepcopy(self.domain_goals)
